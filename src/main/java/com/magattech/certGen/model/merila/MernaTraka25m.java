...
@AllArgsConstructor
@Entity
@Table(name = "_merna_traka_25m")
public class MernaTraka25m {
        @Id
        ...
        public MernaTraka25mND getMernaTraka25mND(){
                MernaTraka25mND mernaTraka25mND = MernaTraka25mND.builder().ndg1(this.ndg1).ndg2(this.ndg2).ndg3(this.ndg3).ndg4(this.ndg4)
                ...
                return mernaTraka25mND;
        }

        public MeriloHelper getMeriloHeplper(){
            MeriloHelper meriloHelper = MeriloHelper.builder().nazivMerila("Мерна трака").brojZapisnika(this.brojZapisnika)
                    .tip(this.oznakaTipa)
